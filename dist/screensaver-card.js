    ...
    `}_addEntityToEntityIcon(){const t=this.shadowRoot.getElementById("entity_icon_select");if(t&&t.value){const e=t.value;this._entityIcons.some((t=>t.entity===e))||(this._entityIcons=[...this._entityIcons,{entity:e}],this._updateEntityIconConfig()),t.value=""}}_renderEntityIconList(){return D`
      <div style="margin-top: 1ch;">
        ${this._entityIcons.length>0?D`
              <ul>
                ${this._entityIcons.map(((t,e)=>{const i=t.entity,n=t.icon,s=this.hass.states[i],a=i.split(".")[0],o=s?.attributes?.device_class;let r;if(n)r=n;else if(yt(i,"cover"))r=vt(o);else if(yt(i,"binary_sensor"))r=gt(o);else if(yt(i,"sensor")){r=mt(o,Number(s?.state)||0)}else r=_t[a]||ft(this.hass,i,"icon")||"mdi:eye";return D`
                    <li>
  ...
  c0.67,0,1.65,0.17,2.54,0.99"
        ...
        ${y?D`
              <div
                ...
                class="${_?"visible":"hidden"}"
              >
                ${_?this.renderEntityState():""}
              </div>
              <div
                style="grid-area: cal-event;align-self: end;"
                class="${_?"hidden":"visible"}"
              >
                ${_?"":this.renderEvents()}
              </div>
            `:D`
